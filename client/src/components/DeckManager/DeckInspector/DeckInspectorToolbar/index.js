    ...
    <StyledDeckInspectorToolbar>
      <div className="DeckInspectorToolbarHeader">
        <div className="DeckInspectorTitle">
          ...
          <p>
            {capitalise(format)}{" "}
            {format === "commander" ? <em>{` (${commander.name})`}</em> : null}
          </p>
        </div>
        {currentUserOwnsDeck && (
          <div className="DeckInspectorHeaderButtons">
            ...
            <Link
              to={{
                pathname: `/decks/${props.deck.id}/export`,
                state: { deck: props.deck }
              }}
            >
              <Button type="button">
        ...
        <DeckInspectorControlGroup>
          <ModeToggleContainer>
            <button
              ...
              onClick={() => changeViewModeHandler("gallery")}
            >
              Gallery
            </button>
            <button
              ...
              onClick={() => changeViewModeHandler("text")}
            >
              Text
            </button>
            ...
            <button
              ...
              onClick={() => changeViewModeHandler("list")}
            >
              List
            </button>
          </ModeToggleContainer>
